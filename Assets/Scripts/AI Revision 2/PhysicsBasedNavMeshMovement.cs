...
public class PhysicsBasedNavMeshMovement : MonoBehaviour
{
    ...
    {
        // Enable rigidbody and prevent the navmesh from updating its position automatically (so that the agent can do it instead)
    ...
    */
    private void FixedUpdate()
    {
        ...
        */
        ...
        if (!navMeshAgent.updatePosition && !rigidbody.isKinematic)
        {
