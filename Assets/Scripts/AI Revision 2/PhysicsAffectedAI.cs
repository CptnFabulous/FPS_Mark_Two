...
public class PhysicsAffectedAI : MonoBehaviour
{
    ...
    public IEnumerator SetRagdollActiveState(bool value)
    {
        ...
        else
        {
            ...
            aiTransform.position = ragdollTransform.position;
            aiTransform.rotation = Quaternion.LookRotation(ragdollTransform.forward, aiTransform.up);
            ...
            ragdollTransform.position = aiTransform.position;
            ragdollTransform.localRotation = aiTransform.rotation;
